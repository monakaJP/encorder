class RawArray {
     ...
     */
     static copy = (dest, src, numElementsToCopy, destOffset = 0, srcOffset = 0) => {
     ...
     */
     static isZeroFilled = (array) => array.every((value) => 0 === value);
     ...
     */
     static deepEqual = (lhs, rhs, numElementsToCompare) => {
