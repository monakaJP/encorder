...
// README: This is copied from tweeetnacl/nacl.fast.js and is updated to custom hash functions.
...
const crypto_verify_32 = (x, xi, y, yi) => {
...
function encode(senderPriv, recipientPub, msg, isHexString = false) {
    // Errors
...
function _encode(senderPriv, recipientPub, msg, iv) {
    // Errors
    ...
    const encrypted = Buffer.concat([cipher.update(Buffer.from(converter.hexToUint8(msg))), cipher.final()]);
